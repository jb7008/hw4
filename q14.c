 ...
 *
 * Calculates half_life of Cobalt_60
 */

#include <stdio.h> /* Includes printf, scanf */
#include <math.h> /* Includes pow */

#define CO_HALF_LIFE 5.272 /* Constant of the half_life of cobalt_60 */
#define FIVE_YEARS 5

int
main(void)
{
  int co_amt; /* Amount of Cobalt_60 */
  double remaining_amt; /* Amount of Cobalt_60 remaining */
  ...
  printf("Year\t\tAmount\n");
  /* Prints cobalt_60 amount for 5 years in the future */
